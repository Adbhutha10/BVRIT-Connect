    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-4">
      <div className="w-full max-w-md">
          ...
          <CardContent>
            {!emailSent ? (
              ...
              <div className="text-center py-4">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mt-4 text-left flex items-start gap-3">
                  <div className="h-8 w-8 rounded-lg bg-amber-100 flex-shrink-0 flex items-center justify-center">
                    <Mail className="h-4 w-4 text-amber-600" />
                  </div>
                  <p className="text-sm text-amber-800">
                    <strong>Can't find the email?</strong> Check your spam folder or wait a few minutes before requesting again.
                  </p>
                </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-400">
          Need help? Contact <span className="text-blue-600">support@bvritconnect.com</span>
        </p>
      </div>
    </div>
  );
